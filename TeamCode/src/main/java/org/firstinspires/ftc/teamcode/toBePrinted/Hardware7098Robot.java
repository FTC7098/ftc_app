...
{
    // This class is fairly self-documenting and thus line-by-line comments are not provided. Overall, this class is used to abstract the implementation of moving the robot. Instead of moving individual motors, we have simplified it with methods like drive(power). Some of the methods below are not completely finalized and/or implemented. If so, it has been appropriately marked.
